...
<head>
    ...
    <?php 
        if($page['name']=='program') {
            ...
            // Első és utolsó esemény időpontjának kinyerése
            $first_time = $data[0]['programs'][0]['startTime'];
            $last_time = end($data[0]['programs'])['endTime'];

            // Helyszínek számának meghatározása
            $venues = count($data);
